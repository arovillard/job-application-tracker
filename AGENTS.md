...
2. Collect the user's project location, application-materials directory, base resume path, public profile URL, and whether their AI provider is configured in the host agent.
