...
| `WORKFLOW-005` | Fresh `terra-worker` | Three source skills, three Claude mirrors, workflow/installer tests | `INTAKE-004` | Complete (`59f2f48`, `788860b`) | GREEN 29/29 contract/install; 148/148 dependency regressions; lint/mirror/diff checks pass | Re-review approved; no findings |
...
| `workflow-005-implement-1` | `WORKFLOW-005` | `implement` | 1 | `terra-worker` | Complete (`59f2f48`) | Native per-dispatch usage unavailable; report `workflow-005-implement-1.md` |
| `workflow-005-review-1` | `WORKFLOW-005` | `review` | 1 | `sol-reviewer` | Readiness, supplied-link order, scoring guidance, and failure-semantics findings returned | Native per-dispatch usage unavailable; report `workflow-005-review-1.md` |
| `workflow-005-fix-1` | `WORKFLOW-005` | `fix` | 1 | `terra-worker` | Complete (`788860b`) | Native per-dispatch usage unavailable; appended implementation report |
| `workflow-005-rereview-1` | `WORKFLOW-005` | `re-review` | 2 | `sol-reviewer` | Approved; no findings | Native per-dispatch usage unavailable; report `workflow-005-rereview-1.md` |
